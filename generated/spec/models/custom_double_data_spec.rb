...
# Unit tests for SwaggerClient::CustomDoubleData
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CustomDoubleData' do
  before do
    # run before each test
    @instance = SwaggerClient::CustomDoubleData.new
  end
  ...
  describe 'test an instance of CustomDoubleData' do
    it 'should create an instact of CustomDoubleData' do
      expect(@instance).to be_instance_of(SwaggerClient::CustomDoubleData)
    end
  end
