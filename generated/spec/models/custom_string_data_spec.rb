...
# Unit tests for SwaggerClient::CustomStringData
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CustomStringData' do
  before do
    # run before each test
    @instance = SwaggerClient::CustomStringData.new
  end
  ...
  describe 'test an instance of CustomStringData' do
    it 'should create an instact of CustomStringData' do
      expect(@instance).to be_instance_of(SwaggerClient::CustomStringData)
    end
  end
